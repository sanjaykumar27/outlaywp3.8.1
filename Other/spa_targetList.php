...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
	<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
		<div class="d-flex align-items-center flex-wrap mr-2">
			<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Goal List</h5>
		</div>
		<div class="d-flex align-items-center">
			<a href="javascript:void(0)" class="btn btn-icon btn-primary mr-2" data-toggle="modal" data-target="#createtarget">
...
<div class="d-flex flex-column-fluid pt-2">
	<div class="container-fluid">
		<div class="row">
			<div class="col-xl-6" dmx-repeat:repeattargets="scTargetList.data.queryTargetList.data.sort(IsCompleted)">
						...
						<div class="d-flex flex-wrap align-items-center py-1">
							...
							<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
								<a href="#" class="text-dark font-weight-bolder text-hover-primary font-size-h5 py-1 border-bottom">
									{{target_name}} <span dmx-hide="IsCompleted" class="label label-lg label-primary label-inline float-right" dmx-on:click="varTargetID.setValue(id);modalTransaction.show()">
										<i class="fa fa-plus text-white"></i> &nbsp;Transaction
									</span>
								</a>
								<span class="text-muted font-weight-bold font-size-lg py-1 border-bottom">
									{{target_description}}
								</span>
								<h4 class="py-2 border-bottom"> <span class="text-success mrs-2">{{(TotalCredit - TotalDebit).formatCurrency("₹ ", ".", ",", "2")}}</span> of <span
										class="text-danger ml-2">{{target_amount.formatCurrency("₹ ", ".", ",", "2")}}</span></h4>
							</div>
