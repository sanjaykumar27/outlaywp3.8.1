      ...
      <div class="row justify-content-center">
        <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5">
          ...
          <div class="register-form mt-4 px-4">
            <form action="https://designing-world.com/affan-1.0/page-home.html">
          ...
          <!-- <div class="login-meta-data text-center"><a class="stretched-link forgot-password d-block mt-3 mb-1" href="page-forget-password.html">Forgot Password?</a>
              <p class="mb-0">Didn't have an account?<a class="ms-1 stretched-link" href="page-register.html">Register Now</a></p>
            </div> -->
        </div>
      </div>
    </div>
