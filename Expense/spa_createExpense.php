...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
	<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
		...
		<div class="d-flex align-items-center">
			<a href="./expense/list" class="btn btn-primary  ">
...
<div class="container-fluid">
	<form class="form" method="post" is="dmx-serverconnect-form" id="CreateExpense" action="dmxConnect/api/Expense/createExpense.php"
		...
		<div class="card card-custom card-stretch gutter-b mb-2">
			<div class="card-body border-dark-75 rounded">
				<div class="row mb-2 py-1 row rounded p-2">
					...
					<div class="col offset-lg-6 offset-md-3">
						<div class="mb-3">
				...
				<div class="border rounded-lg table-responsive my-5 bg-light-o-25">
					<table class="table table-head-custom table-vertical-center">
						...
						<tbody is="dmx-repeat" id="repeatItems" dmx-bind:repeat="varCounter.value">
							...
							<td>
								...
								<button class="btn btn-icon btn-light-danger me-2 btn-lg fw-500" dmx-show="varCounter.value != 1" dmx-on:click="varCounter.setValue(varCounter.value - 1)">
		...
		<div class="row mt-2">
			<div class="col ">
				<button class="btn btn-primary me-2 btn-lg fw-500" dmx-on:click="varCategoryID.setValue(repeatItem.CategoryID.value);modalAddItem.show()">Add Item</button>
			</div>
